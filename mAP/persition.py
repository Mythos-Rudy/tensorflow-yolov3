...
parser.add_argument('--max_IOU_thd', default=0.4, type=float, help="IOU compute")
parser.add_argument('--min_IOU_thd', default=0.15, type=float, help="IOU compute")
...
def count_gt(save_path,ground_truth_files_list):
    ...
    for txt_file in ground_truth_files_list:
        ...
        for line in lines_list:
            ...
            bounding_boxes.append({"class_name":class_name, "bbox":bbox, "used":False, "easy_mode_used":False})
